                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                              ...
                              {/* WhatsApp — always shown, opens wa.me in new tab */}
                              <motion.button 
                                onClick={() => {
                                ...
                                className="h-9 w-9 rounded-lg flex items-center justify-center border border-[#25D366]/20 text-[#25D366] hover:bg-[#25D366]/10 hover:border-[#25D366]/40 transition-all duration-200 ease-out will-change-transform"
                              >
                                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.116 1.523 5.847L.057 23.804a.5.5 0 0 0 .61.641l6.174-1.617A11.944 11.944 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.882a9.868 9.868 0 0 1-5.026-1.371l-.36-.214-3.733.977.999-3.645-.235-.374A9.84 9.84 0 0 1 2.118 12C2.118 6.536 6.536 2.118 12 2.118c5.465 0 9.882 4.417 9.882 9.882 0 5.464-4.417 9.882-9.882 9.882z"/>
                                </svg>
                              </motion.button>
